...
# Path to the embedded RSA bypass key in DER format
_BYPASS_DER_PATH = Path(__file__).parent / "data" / "bypass_rsa.der"
...
def generate_bypass_key() -> tuple[str, str]:
    ...
    try:
        ...
        raise RuntimeError(
            ...
            "Run 'aspera setup' to install it, or reinstall the package."
        ) from None
